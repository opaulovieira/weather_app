...
abstract class $TemperatureCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'temp') double value,
      @JsonKey(name: 'feels_like') double feelsLike,
      @JsonKey(name: 'temp_min') double min,
      @JsonKey(name: 'temp_max') double max});
}
...
class _$TemperatureImpl implements _Temperature {
  const _$TemperatureImpl(
      {@JsonKey(name: 'temp') required this.value,
      @JsonKey(name: 'feels_like') required this.feelsLike,
      @JsonKey(name: 'temp_min') required this.min,
      @JsonKey(name: 'temp_max') required this.max});
  ...
  @override
  String toString() {
    return 'Temperature(value: $value, feelsLike: $feelsLike, min: $min, max: $max)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, value, feelsLike, min, max);
...
abstract class _Temperature implements Temperature {
  const factory _Temperature(
          {@JsonKey(name: 'temp') required final double value,
          @JsonKey(name: 'feels_like') required final double feelsLike,
          @JsonKey(name: 'temp_min') required final double min,
          @JsonKey(name: 'temp_max') required final double max}) =
      _$TemperatureImpl;
